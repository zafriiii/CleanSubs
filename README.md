...
- Windows 10/11  
- Simply run the provided `CleanSubs.exe`

## Usage

1. **Launch the Application:**  
   Double-click the `CleanSubs.exe` file to start the application.

2. **Select Subtitle Files:**  
   Click the **Select SRT Files** button and choose one or more `.srt` files.
